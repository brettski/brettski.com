	...
	<div class="relative pt-6 pb-16 sm:pb-24">
		<main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
			<div class="text-center">
				...
				>
					Hi! I'm Brett Slaski, an IT operations engineer and software developer. Let's spend some
					time together automating all the things and building cool applicaitons with things like

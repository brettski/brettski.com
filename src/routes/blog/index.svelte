    ...
    -->
      ...
      -->
			...
			>
				...
				<form class="mt-4 border-t border-gray-200">
					...
					<ul role="list" class="font-medium text-gray-900 px-2 py-3">
						...
						<li>
							<a
								href="http://brettskisayings.blogspot.com/"
								target="_blank"
                  ...
                  -->
									<svg
										class="h-5 w-5 {categoryPlus(categoryState)}"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 20 20"
										fill="currentColor"
										aria-hidden="true"
                  ...
                  -->
									<svg
										class="h-5 w-5 {categoryMinus(categoryState)}"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 20 20"
										fill="currentColor"
										aria-hidden="true"
                  ...
                  -->
									<svg
										class="h-5 w-5 {colorPlus(colorState)}"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 20 20"
										fill="currentColor"
										aria-hidden="true"
                  ...
                  -->
									<svg
										class="h-5 w-5 {colorMinus(colorState)}"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 20 20"
										fill="currentColor"
										aria-hidden="true"
		...
		<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			>
				<!-- <h1 class="text-4xl font-extrabold tracking-tight text-gray-900">New Arrivals1</h1> -->
				<div class="mx-auto">
					<img class="rounded-lg opacity-90" src="/images/itslug11.jpg" alt="B" />
				</div>
				...
				<div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
					...
					<form class="hidden lg:block">
						...
						>
							...
							<li>
								<a href="http://sayings.brettski.com/" target="_blank"> The Bar Napkin </a>
							</li>
							<li>
								<a href="https://twitter.com/brettslaski" target="_blank"> Twitter </a>
							</li>
							<li>
								<a href="https://www.thatconference.com" target="_blank"> THAT Conference </a>
							</li>
						</ul>
					...
					<div class="lg:col-span-3">
						...
						<div class="border-4 border-dashed border-gray-200 rounded-lg h-96 lg:h-full">
							<div class="p-5">Content goes here!</div>
						</div>
						<!-- /End replace -->
					</div>
				</div>
